...
async function main() {
  ...
  const achievements = [
    ...
    },
    {
      key: 'hours_1000',
      title: 'Mil Horas',
      description: 'Acumulou 1000 horas de estudo — lenda!',
      icon: '⚡',
      category: 'hours',
      threshold: 1000,
    },
    ...
    },
    {
      key: 'questions_5000',
      title: '5000 Questões',
      description: 'Respondeu 5000 questões — mestre das questões!',
      icon: '🎯',
      category: 'questions',
      threshold: 5000,
    },
    {
      key: 'weekly_goal',
      title: 'Meta Semanal',
      description: 'Atingiu a meta semanal de horas',
      icon: '✅',
      category: 'goal',
      threshold: 1,
    },
